...
<footer class="mt-9 bg-red max-sm:mt-10">
    ...
    <div class="flex justify-between bg-[#FFFFFF] px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
        {!! view_render_event('bagisto.shop.layout.footer.footer_text.before') !!}

        <p class="text-sm text-white max-md:text-center">
    © 2026 PT. Samudera Niaga Tehnik. All rights reserved.
</p>
